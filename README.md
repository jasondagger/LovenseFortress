...
6. Copy the **Local IP** & **Port** found in the Lovense Remote app to the LovenseFortress app in the Config tab & press **Set** for both the **Lovense Local IP** & **Lovense Port**.
